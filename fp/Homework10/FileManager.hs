...
main = do
  ...
  defaultIconTheme <- iconThemeGetDefault
  listIcons <- iconThemeListIcons defaultIconTheme Nothing
  putStrLn $ show (listIcons::[String])
  ...
  fInfos <- mapM (\info -> do
                   ...
                   pixbuf <- case iconInfo of
                              ...
                              Nothing -> liftM fromJust $ iconThemeLoadIcon iconTheme "emacs" 24 IconLookupUseBuiltin
